...
const deleteSurvey = (browser) => {
    browser
        .useXpath()
        .waitForElementVisible(selectors.mySurveys, 5000)
        .click(selectors.mySurveys)
        .waitForElementVisible(selectors.threeDots, 5000)
        .click(selectors.threeDots)
        .click(selectors.deleteSurvey)
        .waitForElementVisible(selectors.redDelete, 5000)
        .assert.containsText(selectors.testDeleteTitle, "Sports")
...
let editQuestionFunction=(browser,selectors,data)=>{
    ...
    .useXpath()
    .waitForElementVisible(selectors.questionInput,5000)
...
let analyzingDataFunction = (browser,selectors,data) => {
    ...
    .useCss()
    .waitForElementVisible(selectors.analyzeResultsButton,5000)
    .click(selectors.analyzeResultsButton)
    .waitForElementVisible(selectors.questionsSummaries,5000)
    ...
    .waitForElementVisible(selectors.dataTrendsPage,5000)
